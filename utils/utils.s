...
str_d_find_end
	...
	bra str_d_find_end
str_d_found_end
	cpy #6+1			; Biggest int is 6 chars
	bcs str_d_error		; e.g. -32767 including minus
	sty num_tmp+3
	stz num_tmp+2
	stz num_a
	stz num_a+1
...
int_to_str
	...
	pla							; Restore A
int_to_str_skip_neg
 	jsr word_to_bcd				; Convert X,A to BCD
